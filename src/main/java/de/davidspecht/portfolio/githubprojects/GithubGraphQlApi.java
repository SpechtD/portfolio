...
public interface GithubGraphQlApi {
    RepositoryOwner repositoryOwner(@NonNull String login,
                                    @NestedParameter("repositories") @Name("first") int firstRepos,
                                    @NestedParameter("repositories") RepositoryOrder orderBy,
                                    @NestedParameter("repositories.nodes.languages") @Name("first") int firstLangs);
}
